...
To create a new environment with a different version of Python, use the :doc:`conda create </examples/create>` command. In this example, we'll make the new environment for Python 3.4: 
