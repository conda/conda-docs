...
have a metapackage that includes a compiler that lists ``run_exports``, you need
to also define ``run_exports`` in the metapackage if you want it to take effect
...
build time dependency, bzip2 should not be automatically imposed as a runtime
dependency for the thing using python - it should only be imposed for python itself.
