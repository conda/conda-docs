...
Miniconda is a minimal installer for conda. It is a small, bootstrap
...
.. note::
   ...
   These installers are all pulling from repo.anaconda.com and should be used in compliance with Anaconda’s terms of service.
